...
export default function AboutUs() {
  ...
  const stats = [
    ...
    { icon: <DollarSign className="w-12 h-12 text-blue-200" />, value: 1, label: "Property Value Sold", prefix: "$", suffix: "B+" },
  ]
  ...
  return (
    <div className="bg-gray-100">
      <div className="min-h-screen mx-10 bg-gray-100">
        <main className="container mx-auto px-4 py-16">
          <section className="mb-24">
            ...
            <div className="flex flex-col md:flex-row items-center gap-12">
              ...
              >
                <Image
                  src="/assets/about.png?height=800&width=800"
                  alt="Luxury Home"
                  width={800}
                  height={800}
              ...
              >
                <p className="text-lg md:text-xl leading-relaxed">
                  Welcome to LandmarkRealEstate, a premier real estate agency! With over two decades of experience in the property market,
